              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-xl font-black text-stone-800 uppercase tracking-tighter">
                    Radar Referencial v2.0
                  </h3>
                  <p className="text-[10px] font-black text-stone-400 uppercase tracking-widest">
                    Búsqueda: {results.searchQuery}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="max-w-6xl mx-auto space-y-12 pb-12">
                ...
                <div className="bg-blue-50/50 rounded-3xl p-8 border border-blue-100 flex gap-6 items-start">
                  ...
                  <div className="space-y-2">
                    <h5 className="text-[12px] font-black text-blue-900 uppercase tracking-widest">
                      Información Técnica
                    </h5>
                    <p className="text-blue-800/70 text-sm leading-relaxed font-medium">
                      Las tiendas con consulta externa utilizan arquitecturas cifradas (Next.js App
                      Router / CSR) que impiden la sincronización automática. El sistema construye
                      el enlace inteligente para optimizar su búsqueda manual.
                    </p>
                  </div>
                </div>
              </div>
