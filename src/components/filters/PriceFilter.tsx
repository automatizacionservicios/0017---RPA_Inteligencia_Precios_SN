                    ...
                    >
                        <div className="grid grid-cols-[1fr,auto,1fr] items-center gap-3 pb-6">
                            <div className="space-y-1.5">
                                <Label htmlFor="min-price" className="text-[9px] font-black text-stone-400 uppercase tracking-tighter ml-1">
                                    Desde
                                </Label>
                            ...
                            <div className="space-y-1.5">
                                <Label htmlFor="max-price" className="text-[9px] font-black text-stone-400 uppercase tracking-tighter ml-1">
                                    Hasta
                                </Label>
                                <div className="relative group">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[9px] font-black text-stone-400 pointer-events-none transition-colors group-focus-within:text-emerald-500">
            ...
            <div className="px-1 pt-1">
                ...
                <div className="flex justify-between mt-3 px-1">
                    <div className="flex flex-col">
                        <span className="text-[9px] font-black text-stone-300 uppercase tracking-tighter">Min. Detectado</span>
                        <span className="text-[10px] font-bold text-stone-500">${minPrice.toLocaleString('es-CO')}</span>
                    </div>
                    <div className="flex flex-col items-end">
                        <span className="text-[9px] font-black text-stone-300 uppercase tracking-tighter">Máx. Detectado</span>
                        <span className="text-[10px] font-bold text-stone-500">${maxPrice.toLocaleString('es-CO')}</span>
                    </div>
                </div>
            </div>
        </div>
