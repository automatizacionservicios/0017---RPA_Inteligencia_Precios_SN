      ...
      <div className="group relative p-8 rounded-[32px] bg-white border border-stone-100 shadow-2xl shadow-stone-200/50 hover:border-emerald-500/20 transition-all duration-500">
        ...
        <div className="flex flex-col h-full">
          ...
          <p className="text-sm font-medium text-stone-500 mb-8 leading-relaxed">
            Sincroniza tus productos directamente desde una hoja pública de Google. Ideal para
            listados largos y control de FK/EAN.
          </p>
        ...
        <div className="flex flex-col h-full">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="text-right">
              <p className="text-[9px] font-black text-emerald-600 uppercase tracking-widest border border-emerald-100 px-3 py-1.5 rounded-lg bg-emerald-50">
                Antibobos Active
              </p>
            </div>
          </div>
            ...
            <div className="mt-4 flex flex-col gap-2 px-2">
              ...
              <div className="p-3 bg-stone-50 rounded-xl border border-stone-100">
                <p className="text-[10px] font-bold text-stone-500 leading-normal italic">
                  💡 Tip: Si pegas desde Excel, asegúrate que el orden sea:{' '}
                  <span className="text-stone-800">Nombre | Marcas | EAN | Precio</span>. Si solo
                  tienes EAN, pégalo en la tercera columna.
                </p>
              </div>
            </div>
          </div>
