            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-6">
                ...
                <div className="w-full space-y-3">
                    <div className="flex justify-between items-end px-1">
                        <span className="text-[9px] font-black text-emerald-600 uppercase tracking-widest">Estado: Orquestando Scrapers</span>
                    ...
                    <div className="flex justify-center pt-2">
                        <span className="text-[8px] font-bold text-stone-300 uppercase tracking-[0.3em] animate-pulse">Deep Intelligence Processing</span>
                    </div>
                </div>
            </div>
        </motion.div>
