...
import BenchmarkSearch, { Store } from "@/components/BenchmarkSearch";
...
const RadarReferencial = () => {
    ...
    const handleSearch = async (
        ...
        setIsLoading(true);
        setCurrentQuery(productName || ean || "");
        setResults(null);
                        ...
                        >
                            <div className="relative w-40 h-40 mx-auto">
                                ...
                                <div className="relative w-40 h-40 rounded-full bg-white shadow-2xl border border-stone-50 flex items-center justify-center p-6 transition-transform hover:scale-105 duration-700">
                                    <img src="/nutresa-tree.png" alt="Nutresa" className="w-full h-full object-contain filter grayscale opacity-40 group-hover:grayscale-0 group-hover:opacity-100 transition-all" />
                                </div>
                            </div>
                            <div className="space-y-4 max-w-lg mx-auto">
                                <h4 className="text-3xl font-black text-stone-900 uppercase tracking-tighter leading-none">Motor Radar <span className="text-emerald-600 italic">Activo</span></h4>
                                <p className="text-stone-400 text-sm font-bold uppercase tracking-widest leading-loose">
                                    Sincroniza precios competitivos, detecta brechas de mercado y optimiza el posicionamiento de Nutresa en segundos.
                                </p>
                            </div>
                        </motion.div>
                    )}
