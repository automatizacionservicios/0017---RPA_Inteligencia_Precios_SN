  ...
  const socialLinks = [
    {
      name: 'Instagram',
      icon: Instagram,
      url: 'https://www.instagram.com/gruponutresa/',
      color: 'hover:text-pink-500',
    },
    {
      name: 'Facebook',
      icon: Facebook,
      url: 'https://www.facebook.com/GrupoNutresa/',
      color: 'hover:text-blue-600',
    },
    {
      name: 'Twitter',
      icon: Twitter,
      url: 'https://twitter.com/GrupoNutresa',
      color: 'hover:text-sky-400',
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      url: 'https://www.linkedin.com/company/grupo-nutresa/',
        ...
        <div className="w-full">
          ...
          >
            ...
            <p className="text-stone-500 max-w-2xl mx-auto font-medium text-lg">
              ¿Tienes dudas, sugerencias o necesitas reportar un problema? Nuestro equipo de
              Inteligencia Comercial está listo para ayudarte.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-xl font-black text-stone-900 uppercase tracking-tight mb-10">
                  Canales Oficiales
                </h3>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-stone-900 font-bold text-lg select-all">
                        radarnutresa@gmail.com
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-stone-500 text-xs font-bold uppercase tracking-widest mt-1 opacity-70">
                        Sede Administrativa
                      </p>
                    </div>
                  </div>
            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="relative z-10">
                  <h3 className="text-3xl font-black text-stone-900 uppercase tracking-tighter mb-4 leading-none">
                    Generar PQR
                  </h3>
                  <p className="text-stone-400 font-medium text-lg mb-12 max-w-xl">
                    Completa el formulario para enviarnos una petición, queja o recurso formal de
                    manera inmediata.
                  </p>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-3">
                      <label className="text-[11px] font-black text-stone-700 uppercase tracking-widest ml-1">
                        Mensaje / Descripción
                      </label>
                      <Textarea
                        required
