...
> = DefaultSchemaTableNameOrOptions extends {
  ...
  ? (DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions['schema']]['Tables'] &
    ...
    ? R // Devuelve `Row`
    : never
  : DefaultSchemaTableNameOrOptions extends keyof (DefaultSchema['Tables'] & DefaultSchema['Views']) // Rama cuando se pasa el nombre directo del recurso en el esquema por defecto
