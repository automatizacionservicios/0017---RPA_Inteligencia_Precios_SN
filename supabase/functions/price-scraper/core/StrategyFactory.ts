...
export class StrategyFactory {
    ...
    private static STORE_CONFIG: Record<string, any> = {
        ...
        mercaldas: { domains: ['www.mercaldas.com'], vtexDomain: 'www.mercaldas.com', scrapeMethod: 'vtex', name: 'MERCALDAS' },
        zapatoca: {
            domains: ['www.mercadozapatoca.com'], scrapeMethod: 'cheerio', name: 'ZAPATOCA',
            searchPath: '/search/?k=',
            selectors: {
        ...
        carulla: {
            domains: ['carulla.com'], scrapeMethod: 'cheerio', name: 'CARULLA',
            searchPath: '/s?q=', selectors: {
        ...
        vaquita: {
            domains: ['vaquitaexpress.com.co'], scrapeMethod: 'cheerio', name: 'LA VAQUITA', searchPath: '/catalogsearch/result/?q=', selectors: {
        ...
        mundohuevo: {
            domains: ['mundohuevo.com'], scrapeMethod: 'cheerio', name: 'MUNDO HUEVO', searchPath: '/search?q=', selectors: {
        ...
        supermu: {
            name: 'SUPER MU', searchPath: '/search?options[prefix]=last&q=', catalogPath: '/collections/all', domains: ['supermu.com'], scrapeMethod: 'cheerio', selectors: {
